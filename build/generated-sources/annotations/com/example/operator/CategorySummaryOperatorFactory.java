...
@Generated("OperatorFactoryClassGenerator:0.1.0")@OperatorFactory(CategorySummaryOperator.class) public class 
    ...
    public static final class SetErrorMessage implements Operator {
        ...
        SetErrorMessage(Source<ErrorRecord> record, String message) {
            ...
            builder.declare(CategorySummaryOperator.class, CategorySummaryOperatorImpl.class, "setErrorMessage");
            builder.declareParameter(ErrorRecord.class);
            builder.declareParameter(String.class);
            builder.addInput("record", record);
            builder.addOutput("out", record);
            builder.addParameter("message", String.class, message);
         ...
         */
        public CategorySummaryOperatorFactory.SetErrorMessage as(String newName) {
    ...
    public static final class SummarizeByCategory implements Operator {
        ...
        SummarizeByCategory(Source<JoinedSalesInfo> info) {
            ...
            builder0.declare(CategorySummaryOperator.class, CategorySummaryOperatorImpl.class, "summarizeByCategory");
            builder0.declareParameter(JoinedSalesInfo.class);
            builder0.addInput("info", info, new ShuffleKey(Arrays.asList(new String[]{"categoryCode"}), Arrays.asList(
                    new ShuffleKey.Order[]{})));
            builder0.addOutput("out", CategorySummary.class);
         ...
         * @throws IllegalArgumentException 引数に{@code null}が指定された場合
         */
        public CategorySummaryOperatorFactory.SummarizeByCategory as(String newName0) {
    ...
    public static final class CheckStore implements Operator {
        ...
        CheckStore(Source<StoreInfo> info, Source<SalesDetail> sales) {
            OperatorDescription.Builder builder1 = new OperatorDescription.Builder(MasterCheck.class);
            builder1.declare(CategorySummaryOperator.class, CategorySummaryOperatorImpl.class, "checkStore");
            builder1.declareParameter(StoreInfo.class);
            builder1.declareParameter(SalesDetail.class);
            builder1.addInput("info", info, new ShuffleKey(Arrays.asList(new String[]{"store_code"}), Arrays.asList(new 
                    ShuffleKey.Order[]{})));
            builder1.addInput("sales", sales, new ShuffleKey(Arrays.asList(new String[]{"store_code"}), Arrays.asList(
                    new ShuffleKey.Order[]{})));
            builder1.addOutput("found", sales);
         ...
         * @throws IllegalArgumentException 引数に{@code null}が指定された場合
         */
        public CategorySummaryOperatorFactory.CheckStore as(String newName1) {
    ...
    public static final class JoinItemInfo implements Operator {
        ...
        JoinItemInfo(Source<ItemInfo> info, Source<SalesDetail> sales) {
            ...
            builder2.declare(CategorySummaryOperator.class, CategorySummaryOperatorImpl.class, "joinItemInfo");
            builder2.declareParameter(ItemInfo.class);
            builder2.declareParameter(SalesDetail.class);
            builder2.addInput("info", info, new ShuffleKey(Arrays.asList(new String[]{"itemCode"}), Arrays.asList(new 
                    ShuffleKey.Order[]{})));
            builder2.addInput("sales", sales, new ShuffleKey(Arrays.asList(new String[]{"itemCode"}), Arrays.asList(new 
                    ShuffleKey.Order[]{})));
            builder2.addOutput("joined", JoinedSalesInfo.class);
            builder2.addOutput("missed", sales);
            builder2.addAttribute(FlowBoundary.SHUFFLE);
            builder2.addAttribute(ObservationCount.DONT_CARE);
            builder2.addAttribute(new OperatorHelper("selectAvailableItem", Arrays.asList(new Class<?>[]{List.class, 
                        SalesDetail.class})));
         ...
         * @throws IllegalArgumentException 引数に{@code null}が指定された場合
         */
        public CategorySummaryOperatorFactory.JoinItemInfo as(String newName2) {
