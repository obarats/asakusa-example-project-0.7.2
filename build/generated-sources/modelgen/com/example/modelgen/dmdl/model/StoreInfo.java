...
import com.example.modelgen.dmdl.io.StoreInfoInput;
import com.example.modelgen.dmdl.io.StoreInfoOutput;
 ...
 * 店舗マスタを表すデータモデルクラス。
 */
@DataModelKind("DMDL")@ModelInputLocation(StoreInfoInput.class)@ModelOutputLocation(StoreInfoOutput.class)@PropertyOrder
        ({"store_code", "store_name"}) public class StoreInfo implements DataModel<StoreInfo>, Writable {
