...
import com.example.modelgen.dmdl.io.ItemInfoInput;
import com.example.modelgen.dmdl.io.ItemInfoOutput;
 ...
 * 商品マスタを表すデータモデルクラス。
 */
@DataModelKind("DMDL")@ModelInputLocation(ItemInfoInput.class)@ModelOutputLocation(ItemInfoOutput.class)@PropertyOrder({
            "item_code", "item_name", "department_code", "department_name", "category_code", "category_name", 
            "unit_selling_price", "registered_date", "begin_date", "end_date"}) public class ItemInfo implements 
        DataModel<ItemInfo>, Writable {
