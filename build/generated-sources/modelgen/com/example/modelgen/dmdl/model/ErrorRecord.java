...
import com.example.modelgen.dmdl.io.ErrorRecordInput;
import com.example.modelgen.dmdl.io.ErrorRecordOutput;
...
@DataModelKind("DMDL")@ModelInputLocation(ErrorRecordInput.class)@ModelOutputLocation(ErrorRecordOutput.class)@
        PropertyOrder({"file_name", "sales_date_time", "store_code", "item_code", "message"}) public class ErrorRecord 
        implements DataModel<ErrorRecord>, Writable {
