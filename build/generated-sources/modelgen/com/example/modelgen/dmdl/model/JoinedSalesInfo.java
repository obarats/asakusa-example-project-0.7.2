...
import com.example.modelgen.dmdl.io.JoinedSalesInfoInput;
import com.example.modelgen.dmdl.io.JoinedSalesInfoOutput;
...
@DataModelKind("DMDL")@Joined(terms = {@Joined.Term(source = SalesDetail.class, mappings = {@Joined.Mapping(source = 
            ...
            group = {"itemCode"}))})@ModelInputLocation(JoinedSalesInfoInput.class)@ModelOutputLocation(
        JoinedSalesInfoOutput.class)@PropertyOrder({"item_code", "amount", "selling_price", "category_code"}) public 
