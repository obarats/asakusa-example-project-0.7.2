...
@DataModelKind("DMDL")@ModelInputLocation(SalesDetailInput.class)@ModelOutputLocation(SalesDetailOutput.class)@
        PropertyOrder({"sales_date_time", "store_code", "item_code", "amount", "unit_selling_price", "selling_price", 
            "file_name"}) public class SalesDetail implements DataModel<SalesDetail>, Writable {
